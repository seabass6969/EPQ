\begin{longtable}{|p{4.5cm}|c|p{7cm}|p{2.5cm}|}
    ...
    & \\
    \hline
    \sourcecite{amandaghassaei_what_nodate} & \cite{amandaghassaei_what_nodate} & 
    ...
    \hline 
    \sourcecite{macleod_abracadabra_nodate} & \cite{macleod_abracadabra_nodate} &
    ...
    & \\
    \hline 
    \sourcecite{steve_brunton_fast_2020} & \cite{steve_brunton_fast_2020} &
